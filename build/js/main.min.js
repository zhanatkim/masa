...
var _renderNewsCards = require("./modules/render-news-cards");
var _newsFilter = require("./modules/news-filter");
// ---------------------------------
...
window.addEventListener('DOMContentLoaded', function () {
  ...
  window.addEventListener('load', function () {
    ...
    (0, _renderNewsCards.createCardsList)(_mocks.newsCards);
    (0, _newsFilter.setFilteredSlides)();
...
},{"./mocks":2,"./modules/accordion/init-accordion":4,"./modules/form-validate/form":6,"./modules/menu":12,"./modules/modals/init-modals":13,"./modules/news-filter":15,"./modules/render-news-cards":17,"./modules/select/custom-select":19,"./utils/ios-vh-fix":23}],2:[function(require,module,exports){
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.newsCards = void 0;
var newsCards = [{
  id: 1,
  theme: 'probation',
  date: '23/03/2023',
...
var menuList = header.querySelector('.nav');
var menuToggle = header.querySelector('.page-header__toggle');
// const subMenuLink = menuList.querySelectorAll('[data-accordion="button"]');

var onNavOutsideClick = function onNavOutsideClick(evt) {
...
},{"../utils/scroll-lock":24}],13:[function(require,module,exports){
"use strict";
...
},{"./modals":14}],14:[function(require,module,exports){
"use strict";
...
},{"../../utils/focus-lock":21,"../../utils/scroll-lock":24}],15:[function(require,module,exports){
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.setFilteredSlides = void 0;
var _newsSwiper = require("./news-swiper");
var _mocks = require("../mocks");
var _renderNewsCards = require("./render-news-cards");
var slidesWrapper = document.querySelector('.news__wrapper');
var buttonsWrapper = document.querySelector('.news__tubs');
var filteredCards = [];
var filterSlides = function filterSlides(evt) {
  ...
  slidesWrapper.querySelectorAll('.news__slide').forEach(function (el) {
    return el.remove();
  });
  if (evt.target.dataset.id === 'default') {
    filteredCards = _mocks.newsCards;
    (0, _renderNewsCards.createCardsList)(filteredCards);
    _newsSwiper.newsSwiper.update();
  }
  filteredCards = _mocks.newsCards.filter(function (el) {
    return el.theme === evt.target.dataset.id;
  });
  (0, _renderNewsCards.createCardsList)(filteredCards);
  _newsSwiper.newsSwiper.update();
};
var setFilteredSlides = function setFilteredSlides() {
  buttonsWrapper.addEventListener('click', filterSlides);
  // setWideFirstSlide();
  // breakpoint.addListener(setWideFirstSlide);
};
exports.setFilteredSlides = setFilteredSlides;

},{"../mocks":2,"./news-swiper":16,"./render-news-cards":17}],16:[function(require,module,exports){
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.newsSwiper = void 0;
var _swiper = _interopRequireDefault(require("../vendor/swiper"));
function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }
// Свайпер для Новости и материалы.

var renderBullets = function renderBullets(index, className) {
  return '<span class="' + className + '">' + (index + 1) + '</span>';
};
var newsSwiper = new _swiper.default('.news__swiper', {
  cssmode: true,
  // centeredSlides: true,
  slidesPerView: 1,
  grid: {
...
exports.createCardsList = void 0;
var slidesWrapper = document.querySelector('.news__wrapper');
var cardTemplate = document.querySelector('#news-card').content;
var breakpoint = window.matchMedia('(min-width:1200px)');
var setWideFirstSlide = function setWideFirstSlide() {
  if (!breakpoint.matches) {
    return;
  }
  var firstSlide = Array.from(slidesWrapper.children)[0];
  firstSlide.dataset.firstSlide = true;
};
var cardContentFragment = document.createDocumentFragment();
var renderCard = function renderCard(_ref) {
  ...
  cardTemplateClone.querySelector('.news-slide__photo').innerHTML = "<picture><source type=\"image/webp\" srcset=\"img/photos/news-card-".concat(id, "-2x.webp 2x, img/photos/news-card-").concat(id, "-1x.webp 1x\">\n  <img src=\"img/photos/news-card-").concat(id, "-1x.jpg\" srcset=\"img/photos/news-card-").concat(id, "-2x.jpg 2x\" alt=\"").concat(title, "\"></picture>");
  return cardTemplateClone;
};
var createCardsList = function createCardsList(cards) {
...
exports.createCardsList = createCardsList;
breakpoint.addListener(setWideFirstSlide);
...
},{"./create-select-markup":18,"./utils":20}],20:[function(require,module,exports){
"use strict";
